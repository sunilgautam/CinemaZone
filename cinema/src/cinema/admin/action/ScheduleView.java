...
public class ScheduleView extends BaseAction
{
    ...
    {
	logger.info("[Validating::" + ScheduleView.class + "]");
	if (this.getSearchDate() == null || this.getSearchDate().equals(""))
	{
	    addActionError(getText("schedule.blank.searchdate"));
	}
	else
	{
	    if (!CommonMethod.isDate(this.getSearchDate()))
	    {
    ...
    {
	logger.info("[Executing::" + ScheduleView.class + "]");
	DBAccess dbObj = new DBAccess();
	List<Schedule> schedules = dbObj.getSchedule(this.getSearchDate());
