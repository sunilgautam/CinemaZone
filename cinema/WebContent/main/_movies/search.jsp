...
<html>
<head>
    <title>Search | <s:property value="search"/> </title>
        ...
        <div class="left contLeft" style="width: 100%;">
            <div class="nowshowingwrapper" style="margin: 2px; overflow: hidden;">
                <div class="nowshowingtop">
                    <span><s:text name="common.search.result"></s:text> (<s:property value="moviesInfo.size()" />)</span>
                </div>
                            ...
                            <div class="postercontainer">
                                <h1 class="posterheader">
                                	<s:a action="movies-details" title="">
										...
										<s:param name="src">s</s:param>
										<s:param name="val" value="search"></s:param>
                                ...
                                <div class="left posterimage">
							    	...
							    	<s:else>
							    		...
							    		<div class="poster-release"><s:date name="#movieInfo.releaseDateName" format="MMM dd, yyyy" /></div>
							    	</s:else>
                                </div>
