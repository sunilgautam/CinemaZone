        ...
        <div class="content-box">
	        <div class="content-box-content">
				...
				<table class="form_table">
			        ...
			        <tr>
			        	<td class="label_cell">
			                <label class="labelClass" for=""><s:text name="screen.view.name"></s:text></label>
			            </td>
			            <td class="control_cell">
			                <label class="labelClass" for=""><s:property value="screen.getScreenName()"/></label>
			            </td>
			        </tr>
			        <tr>
			        	<td class="label_cell">
			                <label class="labelClass" for=""><s:text name="screen.view.pattern"></s:text></label>
			            </td>
			            <td class="control_cell">
			                <label class="labelClass" id="seatPattern" for=""><s:property value="screen.getSeatPattern()"/></label>
			            </td>
			        </tr>
			        <tr>
			        	<td class="label_cell">
			                <s:hidden name="seatPatternId" id="seatPatternId" value="%{screen.getSeatPatternId()}"></s:hidden>
			            </td>
			            <td class="control_cell">
