...
<head>
    ...
    <script type="text/javascript">
    	...
    	var validator = $("#frm_addscreen").validate({
    		rules: {
    			screenName: "required",
			    ...
			    <table class="form_table">
			        <tr>
			            ...
			            <td class="control_cell">
			                <s:textfield name="screenName" maxlength="50" id="screenName" cssClass="inpText" />
			            </td>
			        </tr>
			        <tr>
			        	<td class="label_cell">
			            ...
			            <td class="control_cell">
			                <s:select name="seatPatternId" id="seatPatternId" list="patterns" cssClass="dropList" headerKey="" headerValue="Select"></s:select>
			            </td>
			        </tr>
			        <tr>
			        	<td class="label_cell">
