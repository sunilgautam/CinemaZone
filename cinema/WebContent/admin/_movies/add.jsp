...
<head>
    ...
    <script type="text/javascript">
    	...
    	var validator = $("#frm_addmovie").validate({
    		rules: {
    			movieName: "required",
	    	    director: "required",
	    	    cast: "required",
    ...
    <div class="keepCenter containtWrapper">
        ...
        <div class="content-box">
	        ...
	        <div class="content-box-content">
				...
				<s:form id="frm_addmovie" name="frm_addmovie" action="movies-add-process" method="POST" theme="simple">
			    <table class="form_table">
			        <tr>
			            ...
			            <td class="control_cell">
			                <s:textfield name="movieName" id="movieName" maxlength="100" cssClass="inpText" />
			            </td>
			        </tr>
			        <tr>
			        	<td class="label_cell">
			            ...
			            <td class="control_cell">
			                <s:textfield name="director" maxlength="200" id="director" cssClass="inpText" />
			            </td>
			        </tr>
			        <tr valign="top">
			        	<td class="label_cell">
			            ...
			            <td class="control_cell">
			                <s:textarea name="cast" id="cast" cols="40" rows="4" cssStyle="resize:auto; overflow: auto;" cssClass="inpText"></s:textarea>
			            </td>
			        </tr>
			        <tr>
			        	<td class="label_cell">
			            ...
			            <td class="control_cell">
			                <s:select 
			                	...
			                	headerValue="%{getText('movie.select.genre')}" headerKey="" 
			        ...
			        <tr>
			            ...
			            <td class="control_cell">
			                <s:select 
			                	...
			                	headerValue="%{getText('movie.select.lang')}" headerKey="" 
			        ...
			        <tr>
			            ...
			            <td class="control_cell">
			                <s:select 
			                	name="hours" id="hours" cssClass="dropList" cssStyle="width:90px;"
			                	list="#{ '00':'00' , '01':'01' , '02':'02' , '03':'03' , '04':'04' }"
			                ></s:select>
			                <label>&nbsp;:&nbsp;</label>
			                <s:select 
			                	name="minutes" id="minutes" cssClass="dropList" cssStyle="width:90px;"
			        ...
			        <tr>
			            ...
			            <td class="control_cell">
			                <s:textfield name="releaseDate" maxlength="10" id="releaseDate" cssClass="inpText" />
			            </td>
			        </tr>
			        <tr>
			        	<td class="label_cell">
			            ...
			            <td class="control_cell">
			                <s:select 
			                	name="cbRating" id="cbRating" cssClass="dropList"
			        ...
			        <tr valign="top">
			            ...
			            <td class="control_cell">
			                <s:textarea name="synopsis" id="synopsis" cols="40" rows="6" cssStyle="resize:auto; overflow: auto;" cssClass="inpText"></s:textarea>
			            </td>
			        </tr>
			        <tr>
			        	<td class="label_cell">
