	        ...
	        <div class="content-box-content">
			    ...
			    <table class="form_table">
			        ...
			        <tr>
			            ...
			            <td class="control_cell">
			                <s:textfield name="movieName" id="movieName" cssClass="inpText" value="%{movie.getMovieName()}" />
			            </td>
			        </tr>
			        <tr>
			        	<td class="label_cell">
			            ...
			            <td class="control_cell">
			                <s:textfield name="director" id="director" cssClass="inpText" value="%{movie.getDirector()}" />
			            </td>
			        </tr>
			        <tr valign="top">
			        	<td class="label_cell">
			        ...
			        <tr>
			            ...
			            <td class="control_cell">
			                <s:select 
			                	...
			                	list="#{ 'Comedy':'Comedy' ,'Romance':'Romance' ,'Action':'Action' ,'Fantasy':'Fantasy' ,'Horror':'Horror' ,'Science Fiction':'Science Fiction' ,'Thriller':'Thriller' , 'Adventure':'Adventure' }"
			                ></s:select>
			            </td>
			        </tr>
			        <tr>
			        ...
			        <tr>
			            ...
			            <td class="control_cell">
			                <s:textfield name="releaseDate" id="releaseDate" cssClass="inpText" value="%{movie.getReleaseDate()}" />
			            </td>
			        </tr>
			        <tr>
			        	<td class="label_cell">
